...
namespace Recursos_Humanos.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Empleado_id,Desde,Hasta,Motivos,Comentarios")] Licencias licencias)
        {
            ...
            ViewBag.Empleado_id = new SelectList(db.Empleados, "Id", "Nombre", licencias.Empleado_id);
            return View(licencias);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Empleado_id,Desde,Hasta,Motivos,Comentarios")] Licencias licencias)
        {
            if (ModelState.IsValid)
            {
